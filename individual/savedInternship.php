...
<section class="courses">
    ...
    <div style="    display: flex;     flex-direction: row;     width: 50%;     margin: 0 25%;     border-radius: 20px;     flex-wrap: nowrap;     justify-content: center;     align-items: center;">
        ...
        <input type="text" name="" id="search-item" placeholder="Search By Internships Name" onkeyup="pendingCompanySearch()" style="width: 50%;     height: 30px;     margin-left: 3%;     border: none;     border-radius: 20px;">                            
    </div>
...
<?php
    ...
    LEFT JOIN internship ON bookmarks.internship_ID = internship.internship_ID
    
    WHERE bookmarks.user_ID = $individual_ID AND bookmarks.user_role='individual' AND bookmarks.internship_ID != 0";
    ...
    if(!mysqli_num_rows($result)>0){
        echo"<p class='empty'>No Saved Internship Yet!</p>";
    }
