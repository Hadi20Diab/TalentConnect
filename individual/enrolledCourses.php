...
<section class="courses">
    ...
    <div style="    display: flex;     flex-direction: row;     width: 50%;     margin: 0 25%;     border-radius: 20px;     flex-wrap: nowrap;     justify-content: center;     align-items: center;">
        ...
        <?php
            ...
            LEFT JOIN courses ON course_progress.course_ID = courses.course_ID
            
            WHERE course_progress.course_Status = 'under-progress' AND course_progress.individual_ID=$individual_ID";
