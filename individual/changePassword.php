...
require_once "structural_IndividualPage.php";
...
?>
         <?php 
            $select_profile = mysqli_query($conn, "SELECT * FROM `individuals` WHERE individual_ID = '$individual_ID'");
         ...
         ?>
            ...
            <div class="details">
                ...
                <form action="" method="post">
                    ...
                    <input type="hidden" name="prev_pass_database" value="<?= $fetch_profile['individual_Password']; ?>">
                    <h3 style="color:black ;" name="name" class="box">--> <?= $fetch_profile['individual_Name']; ?> <--</h2>
