<?php 
   ...
   session_unset();
   session_destroy();
   header("location: adminLogin.php");  //after he logout, then it will be redirected to adminLogin.php file which is the login page of admin  in order to relogin agqin if he want 
