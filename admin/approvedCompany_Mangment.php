...
//  header("location:approvedCompany_Mangment.php");
...
//  companyblockid
  if(isset($_GET['companyblockid']) && isset($_GET['name'])){
    ...
    <a href="approvedCompany_Mangment.php?cid='.$cid.'" class="choice-btn yes">yes</a>
    <a href="approvedCompany_Mangment.php" class="choice-btn no">No</a>
  ...
  background-color: var(--white);
            ...
            <div class="details">
                ...
                <?php
                   ...
                   $approved_companies_count = mysqli_num_rows($select_approved_companies);
                        ...
                        <div class="recentOrders scroll">
                            ...
                            <div class="cardHeader" style="margin:2.5rem 0 ;     justify-self: left;     place-items: center;">
                                <a href="companys_Management.php" style="display: flex;     place-items: center;">
                                    ...
                                    <h2 style="margin: 0 20px;">Approved companies</h2>
                                </a>
                ...
                ?>
                        ...
                        <tbody id="containerApprovedROW">
                                ...
                                <div style="    display: flex;     flex-direction: row;     width: 50%;     margin: 0 25%;     border-radius: 20px;     flex-wrap: nowrap;     justify-content: center;     align-items: center;">
                                    ...
                                    <input type="text" name="" id="search-item" placeholder="Search By Company Name" onkeyup="approvedCompanySearch()" style="width: 50%;     height: 30px;     margin-left: 3%;     border: none;     border-radius: 20px;">                            
                                </div>
                        ...
                        <?php
                                ...
                                while ($fetch_approved_companies = mysqli_fetch_assoc($select_approved_companies)) {
                                    $number +=1; 
                                    $rid = $fetch_approved_companies['company_id'];
                        ...
                        ?>
                            <tr id="singleROW">
                                <td><?= $number ?></td>
                                <td width="60px">
                                    <div class="imgBx" style="width: 60px ; height:60px; border-radius:0;"><img src="../uploaded_img/<?= $fetch_approved_companies['company_Logo']; ?>" alt=""></div>
                                </td>
                                <td class="companyName">
                                    <p>
                                        <?= $fetch_approved_companies['company_Name']; ?>
                                </p>
                                </td>
                                <td><?= $fetch_approved_companies['company_Email']; ?></td>
                                <td><?= $fetch_approved_companies['company_Country']; ?></td>

                                <td><a href="viewCompanyProfile.php?vcid=<?= $rid; ?>&cname=<?= $fetch_approved_companies['company_Name']; ?>" class="foods-btn" target="_blank">View</a></td>
                                <!--   <td><input type="submit" class="delete-btn"  name="delete-btn"  value="Block"></td> -->
                                <td style="display: flex; flex-wrap: wrap; margin-top: 30%; ">
                                    <a href="approvedCompany_Mangment.php?companypendingid=<?= $fetch_approved_companies['company_id']; ?>&name=<?= $fetch_approved_companies['company_Name']; ?>"  class="delete-btn" style="background-color: cadetblue;">Pending</a>
                                
                                    <a href="approvedCompany_Mangment.php?companyblockid=<?= $fetch_approved_companies['company_id']; ?>&name=<?= $fetch_approved_companies['company_Name']; ?>"  class="delete-btn">Block</a>
                                </td>
                            ...
                            <script type="text/javascript">
                                function approvedCompanySearch() {
