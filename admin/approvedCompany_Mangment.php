                ...
                ?>
                        ...
                        <?php
                                ...
                                while ($fetch_approved_companies = mysqli_fetch_assoc($select_approved_companies)) {
                                    $number +=1; 
                                    $company_id = $fetch_approved_companies['company_id'];
                        ...
                        ?>
                            <tr id="singleROW">
                                <td><?= $number ?></td>
                                <td width="60px">
                                    <div class="imgBx" style="width: 60px ; height:60px; border-radius:0;"><img src="../images/companies_universities_images/<?= $fetch_approved_companies['company_Logo']; ?>" alt=""></div>
                                </td>
