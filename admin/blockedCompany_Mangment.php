                ...
                ?>
                        ...
                        <?php
                             $number = 0;
                                ...
                                while ($fetch_blocked_companies = mysqli_fetch_assoc($select_blocked_companies)) {
                                    $number +=1; 
                                    $rid = $fetch_blocked_companies['company_id'];
                        ...
                        ?>
                            <tr id="singleROW">
                                <td><?= $number ?></td>
                                <td width="60px">
                                    <div class="imgBx" style="width: 60px ; height:60px; border-radius:0;"><img src="../uploaded_img/<?= $fetch_blocked_companies['company_Logo']; ?>" alt=""></div>
                                </td>
