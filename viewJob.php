...
<?php
        ...
        $row= mysqli_fetch_assoc($result);
            $qCompanyName= "SELECT company_Name From company where company_id=".$row['deliveredBy']."";
            ...
            if(!$resultCompanyName){
                $qCompanyName= "SELECT university_Name From universities where university_ID=".$row['deliveredBy']."";
                $resultCompanyName = mysqli_query($conn,$qCompanyName);
                $CompanyName= mysqli_fetch_assoc($resultCompanyName);
                ...
                <div class=\"container\">
                        <div class=\"scholarship-details-intro\">
                            ...
                            <div class=\"scholarship-details-intro-right\" id=\"s_details\">
                                ...
                                <a href=\"".$row['job_apply_link']."\" target=\"_blank\" >Apply Now</a>
                            </div>
                        </div>
